...
class BasePage:
    ...
    def scroll_to_element(self, locator):
        self.driver.execute_script("arguments[0].scrollIntoView();", self.find_element_on_page(locator))
    ...
    def send_keys_to_input(self, locator, keys):
        self.find_element_on_page(locator).send_keys(keys)
    ...
    @allure.step('Ожидаем, пока текст появится в элементе')
